...
internal enum Asset {
  ...
  internal static let decrementIcon = ImageAsset(name: "decrementIcon")
  internal static let discountRect = ImageAsset(name: "discountRect")
  internal static let downArrow = ImageAsset(name: "downArrow")
  internal static let favorite = ImageAsset(name: "favorite")
  internal static let featherArrow = ImageAsset(name: "featherArrow")
  internal static let iconList = ImageAsset(name: "iconList")
  internal static let incrementIcon = ImageAsset(name: "incrementIcon")
  internal static let meterIcon = ImageAsset(name: "meterIcon")
